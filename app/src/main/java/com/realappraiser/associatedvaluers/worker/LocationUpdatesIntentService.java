...
public class LocationUpdatesIntentService extends IntentService {
    private static final String ACTION_PROCESS_UPDATES = "com.realappraiser.associatedvaluers.worker" +
    ...
    public void onHandleIntent(Intent intent) {
        if (intent != null) {
            if (("com.realappraiser.associatedvaluers.worker.locationupdatespendingintent" +
