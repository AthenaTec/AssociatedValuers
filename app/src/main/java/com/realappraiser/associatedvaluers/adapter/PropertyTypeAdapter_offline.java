...
public class PropertyTypeAdapter_offline extends RecyclerView.Adapter<PropertyTypeAdapter_offline.RecyclerViewHolder> {
    ...
    private ArrayList<TypeOfProperty> propertyTypeList;
    private String property_type = "";
    private Context context;
    private int selectedPosition = -1;


    public PropertyTypeAdapter_offline(Context context, String property_type, ArrayList<TypeOfProperty> propertyTypeList) {
    ...
    public TypeOfProperty typeOfProperty () {
        TypeOfProperty typeOfProperty = new TypeOfProperty();
        if (selectedPosition != -1) {
            typeOfProperty.setTypeOfPropertyId(propertyTypeList.get(selectedPosition).getTypeOfPropertyId());
            typeOfProperty.setName(propertyTypeList.get(selectedPosition).getName());
            typeOfProperty.setPropertyCategoryId(propertyTypeList.get(selectedPosition).getPropertyCategoryId());
        }
