...
import com.realappraiser.gharvalue.Interface.CaseDetailDAO_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceCaseQuery;
import com.realappraiser.gharvalue.Interface.InterfaceCaseQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceDataModelQuery;
import com.realappraiser.gharvalue.Interface.InterfaceDataModelQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceDocumentListQuery;
import com.realappraiser.gharvalue.Interface.InterfaceDocumentListQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceGetPhotoMeasurmentQuery;
import com.realappraiser.gharvalue.Interface.InterfaceGetPhotoMeasurmentQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceGetPhotoQuery;
import com.realappraiser.gharvalue.Interface.InterfaceGetPhotoQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceIndPropertyFloorsQuery;
import com.realappraiser.gharvalue.Interface.InterfaceIndPropertyFloorsQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceIndPropertyFloorsValuationQuery;
import com.realappraiser.gharvalue.Interface.InterfaceIndPropertyFloorsValuationQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceIndPropertyValuationQuery;
import com.realappraiser.gharvalue.Interface.InterfaceIndPropertyValuationQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceIndpropertyQuery;
import com.realappraiser.gharvalue.Interface.InterfaceIndpropertyQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceLatLongQuery;
import com.realappraiser.gharvalue.Interface.InterfaceLatLongQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceOfflineCaseQuery;
import com.realappraiser.gharvalue.Interface.InterfaceOfflineCaseQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceOfflineDataModelQuery;
import com.realappraiser.gharvalue.Interface.InterfaceOfflineDataModelQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfacePropertyQuery;
import com.realappraiser.gharvalue.Interface.InterfacePropertyQuery_Impl;
import com.realappraiser.gharvalue.Interface.InterfaceProximityQuery;
import com.realappraiser.gharvalue.Interface.InterfaceProximityQuery_Impl;
import com.realappraiser.gharvalue.Interface.PropertyUpdateCategory;
import com.realappraiser.gharvalue.Interface.PropertyUpdateCategory_Impl;
import com.realappraiser.gharvalue.Interface.TypeofPropertyQuery;
import com.realappraiser.gharvalue.Interface.TypeofPropertyQuery_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoDataModel.equals(_existingDataModel)) {
          throw new IllegalStateException("Migration didn't properly handle DataModel(com.realappraiser.gharvalue.communicator.DataModel).\n"
                  + " Expected:\n" + _infoDataModel + "\n"
                  + " Found:\n" + _existingDataModel);
        }
        ...
        if (! _infoOfflineDataModel.equals(_existingOfflineDataModel)) {
          throw new IllegalStateException("Migration didn't properly handle OfflineDataModel(com.realappraiser.gharvalue.model.OfflineDataModel).\n"
        ...
        if (! _infoTypeOfProperty.equals(_existingTypeOfProperty)) {
          throw new IllegalStateException("Migration didn't properly handle TypeOfProperty(com.realappraiser.gharvalue.model.TypeOfProperty).\n"
                  + " Expected:\n" + _infoTypeOfProperty + "\n"
        ...
        if (! _infoPropertyUpdateRoomDB.equals(_existingPropertyUpdateRoomDB)) {
          throw new IllegalStateException("Migration didn't properly handle PropertyUpdateRoomDB(com.realappraiser.gharvalue.model.PropertyUpdateRoomDB).\n"
        ...
        if (! _infoCaseModal.equals(_existingCaseModal)) {
          throw new IllegalStateException("Migration didn't properly handle CaseModal(com.realappraiser.gharvalue.model.Case).\n"
                  + " Expected:\n" + _infoCaseModal + "\n"
                  + " Found:\n" + _existingCaseModal);
        }
        ...
        if (! _infoPropertyModal.equals(_existingPropertyModal)) {
          throw new IllegalStateException("Migration didn't properly handle PropertyModal(com.realappraiser.gharvalue.model.Property).\n"
                  + " Expected:\n" + _infoPropertyModal + "\n"
        ...
        if (! _infoIndPropertyModal.equals(_existingIndPropertyModal)) {
          throw new IllegalStateException("Migration didn't properly handle IndPropertyModal(com.realappraiser.gharvalue.model.IndProperty).\n"
        ...
        if (! _infoIndPropertyValuationModal.equals(_existingIndPropertyValuationModal)) {
          throw new IllegalStateException("Migration didn't properly handle IndPropertyValuationModal(com.realappraiser.gharvalue.model.IndPropertyValuation).\n"
        ...
        if (! _infoIndPropertyFloorModal.equals(_existingIndPropertyFloorModal)) {
          throw new IllegalStateException("Migration didn't properly handle IndPropertyFloorModal(com.realappraiser.gharvalue.model.IndPropertyFloor).\n"
        ...
        if (! _infoIndPropertyFloorsValuationModal.equals(_existingIndPropertyFloorsValuationModal)) {
          throw new IllegalStateException("Migration didn't properly handle IndPropertyFloorsValuationModal(com.realappraiser.gharvalue.model.IndPropertyFloorsValuation).\n"
        ...
        if (! _infoProximityModal.equals(_existingProximityModal)) {
          throw new IllegalStateException("Migration didn't properly handle ProximityModal(com.realappraiser.gharvalue.model.Proximity).\n"
                  + " Expected:\n" + _infoProximityModal + "\n"
        ...
        if (! _infoGetPhotoModel.equals(_existingGetPhotoModel)) {
          throw new IllegalStateException("Migration didn't properly handle GetPhotoModel(com.realappraiser.gharvalue.model.GetPhoto).\n"
                  + " Expected:\n" + _infoGetPhotoModel + "\n"
        ...
        if (! _infoCaseDetail.equals(_existingCaseDetail)) {
          throw new IllegalStateException("Migration didn't properly handle CaseDetail(com.realappraiser.gharvalue.model.CaseDetail).\n"
                  + " Expected:\n" + _infoCaseDetail + "\n"
                  + " Found:\n" + _existingCaseDetail);
        }
        ...
        if (! _infoOflineCase.equals(_existingOflineCase)) {
          throw new IllegalStateException("Migration didn't properly handle OflineCase(com.realappraiser.gharvalue.model.OflineCase).\n"
                  + " Expected:\n" + _infoOflineCase + "\n"
                  + " Found:\n" + _existingOflineCase);
        }
        ...
        if (! _infoDocumentList.equals(_existingDocumentList)) {
          throw new IllegalStateException("Migration didn't properly handle Document_list(com.realappraiser.gharvalue.model.Document_list).\n"
                  + " Expected:\n" + _infoDocumentList + "\n"
        ...
        if (! _infoLatLongDetails.equals(_existingLatLongDetails)) {
          throw new IllegalStateException("Migration didn't properly handle LatLongDetails(com.realappraiser.gharvalue.model.LatLongDetails).\n"
                  + " Expected:\n" + _infoLatLongDetails + "\n"
        ...
        if (! _infoGetPhotoMeasurmentModel.equals(_existingGetPhotoMeasurmentModel)) {
          throw new IllegalStateException("Migration didn't properly handle GetPhoto_measurmentModel(com.realappraiser.gharvalue.model.GetPhoto_measurment).\n"
