...
public class FragmentValuationPenthouse_ka_ViewBinding implements Unbinder {
  private FragmentValuationPenthouse_ka target;

  @UiThread
  public FragmentValuationPenthouse_ka_ViewBinding(FragmentValuationPenthouse_ka target,
      View source) {
    this.target = target;
    ...
    target.textview_balcony = Utils.findRequiredViewAsType(source, R.id.textview_balcony, "field 'textview_balcony'", TextView.class);
    target.textview_otla = Utils.findRequiredViewAsType(source, R.id.textview_otla, "field 'textview_otla'", TextView.class);
    target.textview_mezzanine = Utils.findRequiredViewAsType(source, R.id.textview_mezzanine, "field 'textview_mezzanine'", TextView.class);
    ...
    target.textview_on_completion = Utils.findRequiredViewAsType(source, R.id.textview_on_completion, "field 'textview_on_completion'", TextView.class);
    target.textview_on_completion_value = Utils.findRequiredViewAsType(source, R.id.textview_on_completion_value, "field 'textview_on_completion_value'", TextView.class);
    target.textview_dateof_inspection = Utils.findRequiredViewAsType(source, R.id.textview_dateof_inspection, "field 'textview_dateof_inspection'", TextView.class);
    target.textview_dateof_inspection_value = Utils.findRequiredViewAsType(source, R.id.textview_dateof_inspection_value, "field 'textview_dateof_inspection_value'", TextView.class);
    target.textview_realizable = Utils.findRequiredViewAsType(source, R.id.textview_realizable, "field 'textview_realizable'", TextView.class);
    target.textview_distress = Utils.findRequiredViewAsType(source, R.id.textview_distress, "field 'textview_distress'", TextView.class);
    target.otla_div = Utils.findRequiredViewAsType(source, R.id.otla_div, "field 'otla_div'", LinearLayout.class);
    target.mezzanine_div = Utils.findRequiredViewAsType(source, R.id.mezzanine_div, "field 'mezzanine_div'", LinearLayout.class);
    ...
    target.realizable_div_complete = Utils.findRequiredViewAsType(source, R.id.realizable_div_complete, "field 'realizable_div_complete'", LinearLayout.class);
    target.realizable_div_uncomplete = Utils.findRequiredViewAsType(source, R.id.realizable_div_uncomplete, "field 'realizable_div_uncomplete'", LinearLayout.class);
    target.insurance_div = Utils.findRequiredViewAsType(source, R.id.insurance_div, "field 'insurance_div'", LinearLayout.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    FragmentValuationPenthouse_ka target = this.target;
    ...
    target.textview_balcony = null;
    target.textview_otla = null;
    target.textview_mezzanine = null;
    ...
    target.textview_on_completion = null;
    target.textview_on_completion_value = null;
    target.textview_dateof_inspection = null;
    target.textview_dateof_inspection_value = null;
    target.textview_realizable = null;
    target.textview_distress = null;
    target.otla_div = null;
    target.mezzanine_div = null;
    target.textview_areatypetvalue = null;
    target.textview_loadingoverbuildup = null;
    target.realizable_div_complete = null;
    target.realizable_div_uncomplete = null;
    target.insurance_div = null;
  }
}
