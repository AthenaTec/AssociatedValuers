...
public class FragmentFlat_ka_ViewBinding implements Unbinder {
  private FragmentFlat_ka target;

  @UiThread
  public FragmentFlat_ka_ViewBinding(FragmentFlat_ka target, View source) {
    this.target = target;
    ...
    target.saleableloading = Utils.findRequiredViewAsType(source, R.id.saleableloading, "field 'saleableloading'", TextView.class);
    ...
    target.open_calc_plotarea = Utils.findRequiredViewAsType(source, R.id.open_calc_plotarea, "field 'open_calc_plotarea'", ImageView.class);
    ...
    target.open_calc_terracearea = Utils.findRequiredViewAsType(source, R.id.open_calc_terracearea, "field 'open_calc_terracearea'", ImageView.class);
    target.open_calc_balconyarea = Utils.findRequiredViewAsType(source, R.id.open_calc_balconyarea, "field 'open_calc_balconyarea'", ImageView.class);
    target.open_calc_otlaarea = Utils.findRequiredViewAsType(source, R.id.open_calc_otlaarea, "field 'open_calc_otlaarea'", ImageView.class);
    target.open_calc_mezzaninearea = Utils.findRequiredViewAsType(source, R.id.open_calc_mezzaninearea, "field 'open_calc_mezzaninearea'", ImageView.class);
    target.otla_div = Utils.findRequiredViewAsType(source, R.id.otla_div, "field 'otla_div'", RelativeLayout.class);
    target.mezzanine_div = Utils.findRequiredViewAsType(source, R.id.mezzanine_div, "field 'mezzanine_div'", RelativeLayout.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    FragmentFlat_ka target = this.target;
    ...
    target.open_calc_plotarea = null;
    target.open_calc_carpetarea = null;
    target.open_calc_builduparea = null;
    target.open_calc_saleablearea = null;
    target.open_calc_terracearea = null;
    target.open_calc_balconyarea = null;
    target.open_calc_otlaarea = null;
    target.open_calc_mezzaninearea = null;
