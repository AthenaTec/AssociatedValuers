...
public class FragmentLand_ViewBinding implements Unbinder {
  private FragmentLand target;

  @UiThread
  public FragmentLand_ViewBinding(FragmentLand target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FragmentLand target = this.target;
