...
public class FragmentValuationBuilding_ViewBinding implements Unbinder {
  private FragmentValuationBuilding target;

  @UiThread
  public FragmentValuationBuilding_ViewBinding(FragmentValuationBuilding target, View source) {
    this.target = target;
    ...
    target.textview_rate_head = Utils.findRequiredViewAsType(source, R.id.textview_rate_head, "field 'textview_rate_head'", TextView.class);
  ...
  @CallSuper
  public void unbind() {
    FragmentValuationBuilding target = this.target;
    ...
    target.textview_rate_head = null;
